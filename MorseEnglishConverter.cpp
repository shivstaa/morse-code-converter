...
char MorsetoEnglish(char* convertME) { //passes in parameter of type char* that will contain the passed in 
	...
	if (strcmp(convertME, "/") == 0) { //compare string passed in with slash (converts to space)
		return ' ';
	}
	//convert morse letters a-z into english letters a-z (kept lowercase)
	else if (strcmp(convertME, ".-") == 0) {
		return 'a';
	}
	else if (strcmp(convertME, "-...") == 0) {
		return 'b';
	...
	else if (strcmp(convertME, "..-..") == 0) { //comma
		return ',';
	}
	else if (strcmp(convertME, ".-.-.-") == 0) { //period
		return '.';
	}
	else if (strcmp(convertME, "..--..") == 0) { //question mark
		return '?';
	}
	else if (strcmp(convertME, "-.-.-") == 0) { //semicolon
		return ';';
	}
	else if (strcmp(convertME, "---...") == 0) { //colon
		return ':';
	}
	else if (strcmp(convertME, "-..-.") == 0) { //back slash
		return '/';
	}
	else if (strcmp(convertME, ".-.-.") == 0) { //plus symbol
		return '+';
	}
	else if (strcmp(convertME, "-....-") == 0) { //minus symbol
		return '-';
	}
	else if (strcmp(convertME, "-...-") == 0) { //equal symbol
		return '=';
	}
